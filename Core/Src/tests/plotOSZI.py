...
#### DATA PREPARATION #### 
# data_MCU = pd.read_csv('dataMCU/test2.txt',sep=',',header=None)          
data_OSZI = pd.read_csv('dataOSZI/TEK00002.CSV', skiprows=15)           
...
axs[1].plot(time_OSZI, helpled_OSZI, color="red", label="Helpsignal (µCU)")
